    ...
    <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
      ...
      <div className="grid min-h-[520px] lg:grid-cols-[1fr_280px]">
        <div className="flex min-h-[420px] flex-col items-center justify-center bg-slate-50 p-6 text-center">
          <span className="flex h-14 w-14 items-center justify-center rounded-lg bg-sky-100 text-2xl text-sky-800">
            <FaChartBar />
          </span>
          ...
          <span className="mt-5 inline-flex items-center gap-2 rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-sm font-medium text-amber-800">
            <FaLock />
            {report.status}
          </span>
        </div>
